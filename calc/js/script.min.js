!function(e, t) {
    ...
    function P(e) {
        ...
        if (p > a.longSwipesMs) {
            ...
            if (!a.shortSwipes)
                return void t.slideTo(t.activeIndex);
            !t.navigation || o.target !== t.navigation.nextEl && o.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(m + v),
            "prev" === t.swipeDirection && t.slideTo(m)) : o.target === t.navigation.nextEl ? t.slideTo(m + v) : t.slideTo(m)
        }
    }
    function k() {
        const e = this
    ...
    , function({swiper: e, extendParams: t, on: s, emit: a}) {
        ...
        function p() {
            ...
            "bullets" === s.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
                ...
                s.dynamicMainBullets > 1 && void 0 !== e.previousIndex && (n += c - e.previousIndex,
